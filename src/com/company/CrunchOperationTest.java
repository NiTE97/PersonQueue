...
public class CrunchOperationTest {
    ...
    public void sumTest1() {
        float[] arr = {1, 2, 3, 4};
        NumberCruncherTopLevel nc = new Sum(arr);
        nc.crunch(arr);
    ...
    public void swirlTest1() {
        float[] arr = {1, 2, 3, 4};
        NumberCruncherTopLevel nc = new Swirl(arr);
        nc.crunch(arr);
        float[] actual = nc.getNewNumbers();
    ...
    public void divideTest1() {
        float[] arr = {1, 2, 3, 4};
        NumberCruncherTopLevel nc = new Divide(arr);
        nc.crunch(arr);
        float[] actual = nc.getNewNumbers();
    ...
    public void subtractTest1() {
        float[] arr = {2, 4, 6, 8};
        NumberCruncherTopLevel nc = new Subtract(arr);
        nc.crunch(arr);
        float[] actual = nc.getNewNumbers();
    ...
    public void averageTest1() {
        float[] arr = {1, 2, 4, 3};
        NumberCruncherTopLevel nc = new Average(arr);
        nc.crunch(arr);
        float[] actual = nc.getNewNumbers();
